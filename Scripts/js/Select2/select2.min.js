/*! Select2 4.1.0-rc.0 | https://github.com/select2/select2/blob/master/LICENSE.md */ ! function(n) {
    ...
    var e, n, p, o, r, h, f, g, m, v, y, s, i, _, a, a = (t && t.fn && t.fn.select2 && t.fn.select2.amd && (u = t.fn.select2.amd), u && u.requirejs || (u ? n = u : u = {}, g = {}, m = {}, v = {}, y = {}, s = Object.prototype.hasOwnProperty, i = [].slice, _ = /\.js$/, h = function(e, t) {
        ...
        return c.Extend(o, e), o.prototype.render = function() {
            ...
            return i('<li class="select2-selection__choice" draggable="true"><button type="button" class="select2-selection__choice__remove" tabindex="-1"><span aria-hidden="true">&times;</span></button><span class="select2-selection__choice__display"></span></li>')
        }, o.prototype.update = function(e) {
        ...
        return e.prototype.bind = function(e, t, n) {
            ...
            e.call(this, t, n), t.on("*", function(e, t) {
                var n; - 1 !== i.indexOf(e) && (t = t || {}, n = r.Event("select2:" + e, {
                    params: t
        ...
        return e.prototype.bind = function(e, t, n) {
            ...
            for (var i = n.get("tokenSeparators") || [], o = t.term, r = 0, a = this.createTag || function(e) {
                ...
                var l = o[r]; - 1 !== i.indexOf(l) ? (l = o.substr(0, r), null != (l = a(c.extend({}, t, {
                    term: l
