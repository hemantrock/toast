    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  { text: 'Bay No', datafield: 'BayID', cellsalign: 'center', filtertype: "checkedlist", width: "5%" },
                  { text: 'Arm No', datafield: 'ArmNo', cellsalign: 'center', filtertype: "checkedlist", width: "5%" },
                  { text: 'LP No', datafield: 'LoadingPointNo', hidden: true, cellsalign: 'center', filtertype: "checkedlist", width: "0%" },
                  { text: 'ArmMtr#', datafield: 'MeterCompNo', cellsalign: 'center', filtertype: "checkedlist", width: "5%" },
                  { text: 'MeterNo#', datafield: 'MeterNo', cellsalign: 'center', width: "10%" },
                  { text: 'Product', datafield: 'BaseProd', cellsalign: 'center', filtertype: "checkedlist", width: "10%" },
                  { text: 'SlaveID', datafield: 'SlaveID', cellsalign: 'center', filtertype: "checkedlist", width: "5%" },
                  ...
                  { text: 'ObsDens (' + DensityUnit + ')', datafield: 'obsDensity', cellsalign: 'center', width: "9%" },
                  { text: 'Std Density (' + DensityUnit + ')', datafield: 'stdDensity', cellsalign: 'center', width: "8%", hidden: true },
                  { text: 'Mass Flow (' + FlowRateUnit + ')', datafield: 'MassFlowRate', cellsalign: 'center', width: "9%" },
                  { text: 'Flow (m³/Hr)', datafield: 'VFlowRate', cellsalign: 'center', width: "1%", hidden:true },
                  { text: 'Temp (°C)', datafield: 'obsTemp', cellsalign: 'center', width: "6%" },
                  { text: 'Totalizer (' + TotalizerUnit + ')', datafield: 'obsMassTotlzer', cellsalign: 'center', width: "9%" },
                  { text: 'Totalizer(m³)', datafield: 'obsVTotlzer', cellsalign: 'center', width: "1%", hidden:true },
                  { text: 'Pulse/Unit', datafield: 'KFactor', cellsalign: 'center', width: "5%" , hidden: true},
