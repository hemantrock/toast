        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Source', datafield: 'DSName', filtertype: "checkedlist", width: "7%" },
                  ...
                  { text: 'ObsDensity (g/cc)', datafield: 'obsDensity', cellsalign: 'center', width: "7%"},
                  { text: 'StdDensity (g/cc)', datafield: 'stdDensity', cellsalign: 'center', width: "7%" },
                  { text: 'Mass Flow (' + FlowRateUnit + ')', datafield: 'MassFlowRate', cellsalign: 'center', hidden:true, width: "1%" },
                  { text: 'Flow (m³/Hr)', datafield: 'VFlowRate', cellsalign: 'center', width: "6%" },
                  { text: 'Temp(°C)', datafield: 'obsTemp', cellsalign: 'center', width: "5%" },
                  { text: 'Totalizer(m³)', datafield: 'obsVTotlzer', cellsalign: 'center', width: "8%" },
                  { text: 'Totalizer(m³)', datafield: 'obsMassTotlzer', hidden:true, cellsalign: 'center', width: "8%" },
