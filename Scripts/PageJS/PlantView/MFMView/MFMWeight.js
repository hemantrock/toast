    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  { text: 'Bay No', datafield: 'BayID', cellsalign: 'center', filtertype: "checkedlist", width: "4%" },
                  { text: 'Arm No', datafield: 'ArmNo', cellsalign: 'center', filtertype: "checkedlist", width: "4%" },
                  ...
                  { text: 'MeterNo#', datafield: 'MeterNo', cellsalign: 'center', width: "8%" },
                  ...
                  { text: 'Obs Density (' + DensityUnit + ')', datafield: 'obsDensity', cellsalign: 'center', width: "8%" },
                  { text: 'Std Density (' + DensityUnit + ')', datafield: 'stdDensity', cellsalign: 'center', width: "8%" },
                  ...
                  { text: 'Temperature (°C)', datafield: 'obsTemp', cellsalign: 'center', width: "8%" },
                  ...
                  { text: 'Pulse/Unit', datafield: 'KFactor', hidden: true, cellsalign: 'center', width: "5%" },
                  { text: 'Status', datafield: 'ErrMsg', cellsalign: 'left', width: "20%" },
                ]
            });
