...
$(document).ready(function () {
    ...
    //animateShutter(".gate-shutter", '10s');
});
...
function OpenCloseBG(model)
{
    $.each(model, function (i, item) {
        if (item.Value != null && (item.ControlName.toUpperCase() == "BG201_OPN_FB" || item.ControlName.toUpperCase() == "BG201_CLS_FB"))
        {
            ...
            if (item.ClassName.toLowerCase() == "bg_close") {
                if (item.Value.toUpperCase() == "TRUE") {
                    ...
                    if (BGEntryPrevStatus == "close") {
                        ...
                        //animateShutter(".bg_close_false.was-close", '5s');
                    }
                ...
                if (item.Value.toUpperCase() == "TRUE") {
                    ...
                    if (BGEntryPrevStatus == "open") {
                        ...
                        //animateShutter(".bg_open_false.was-open", '10s');
                    }
                    else if (BGEntryPrevStatus == "") {
                        $('#entryShutter').addClass('was-unknown');
                    }
        ...
        else if (item.Value != null &&  (item.ControlName.toUpperCase() == "BG202_OPN_FB" || item.ControlName.toUpperCase() == "BG202_CLS_FB")) {
...
function OpenLocRemModal(TagName, UserID, LoginID, UserName)
{
    ...
    $('#LOCREMModal .BGENTRY_LOCREM').removeClass('bgentry_locrem_false').removeClass('bgentry_locrem_true').removeClass('BGENTRY_LOCREM').addClass(TagName);
    $('#LOCREMModal .BGEXIT_LOCREM').removeClass('bgexit_locrem_false').removeClass('bgexit_locrem_true').removeClass('BGEXIT_LOCREM').addClass(TagName);
...
function OpenAutoManModal(BarrierDetails, TagName, UserID, LoginID, UserName) {
    ...
    $('#AutoManModal .BGENTRY_AUTOMAN').removeClass('bgentry_automan_false').removeClass('bgentry_automan_true').removeClass('BGENTRY_AUTOMAN').addClass(TagName);
    $('#AutoManModal .BGEXIT_AUTOMAN').removeClass('bgexit_automan_false').removeClass('bgexit_automan_true').removeClass('BGEXIT_AUTOMAN').addClass(TagName);
