        ...
        success: function (result) {
                    ...
                    var productData = `<table class = 'table-striped app-tbl jqx-app-tbl'>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class = ` + datarecord.TagPrefix + `_LVL_HHH> ` + datarecord.SafeFillingHeight + ` </span> `+TFMSLevelUnit+`</td>
                    ...
                    var densityData = `<table class = 'table-striped app-tbl jqx-app-tbl'>
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td class ='bold'>Vapour Pressure</td>
                                           <td><span class = ` + datarecord.TagPrefix + `_VP> ` + datarecord.VapPress + ` </span> Kg/cm²</td>
                                        </tr>
                                        <tr>
            ...
            $("#jqxgridTkLiveData").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Tank Code', datafield: 'TankCode', cellsalign: 'left', filtertype: "checkedlist", width: "6%", pinned: true },
                  ...
                  { text: 'Tank Mode', datafield: 'TankMode', displayfield: 'TankModeName', cellsalign: 'left', width: "12%" },
                  { text: 'Radar Level<br/>('+TFMSLevelUnit+')', datafield: 'PriLevel', cellsalign: 'center', width: "8%", renderer: columnrendererDouble },
                  { text: 'Avg Temp<br/>(°C)', datafield: 'TempAvg', cellsalign: 'center', width: "8%", renderer: columnrendererDouble },
                  { text: 'Vap. Press.<br/>(Kg/cm³)', datafield: 'VapPress', cellsalign: 'center', width: "8%", renderer: columnrendererDouble },
                  { text: 'Tot. Obs. Volume<br/>(KL)', datafield: 'TOV', cellsalign: 'center', width: "8%", renderer: columnrendererDouble },
                  { text: 'Gross Obs Volume<br/>(KL)', datafield: 'GrossObsvol', cellsalign: 'center', width: "8%", renderer: columnrendererDouble },
                  { text: 'Gross Std Volume<br/>(KL)', datafield: 'GrossStdvol', cellsalign: 'center', width: "8%", renderer: columnrendererDouble },
                  { text: 'Rochester Level<br/>(' + TFMSLevelUnit + ')', datafield: 'SecLevel', cellsalign: 'center', width: "8%", renderer: columnrendererDouble },
                  { text: 'Level Diff<br/>Alarm (>5mm)', datafield: 'Pri_Sec_Diff_Alert', cellsalign: 'center', width: "8%", renderer: columnrendererDouble, cellsrenderer: cellsrenderer },
                ]
            });
...
function ExtraActivities(model) {
    console.log('TankLiveData: ExtraActivities');
