...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            var datarenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                return defaulthtml.replace(value,'').replace('class="', 'class="' + value + ' ');
            }
            var moderenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                var html = '<div class="jqx-grid-cell-left-align ' + value + '" style="margin-top: 6px;"><span></span></div>'
                return html;
                //return defaulthtml.replace(value, '').replace('class="', 'class="' + value + ' ');
            }
            ...
            $("#jqxgridTkLiveData").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Tank Mode', datafield: 'TankMode', cellsalign: 'left', width: "10%", cellsrenderer: moderenderer, filterable: false, sortable: false, menu: false },
                  //{ text: 'Tank Mode', datafield: 'TankMode', displayfield: 'TankModeName', cellsalign: 'left', width: "10%", cellsrenderer: datarenderer },
                  { text: 'Level<br/>(' + TFMSLevelUnit + ')', datafield: 'PriLevel', cellsalign: 'center', width: "8%", renderer: columnrendererDouble, cellsrenderer: datarenderer, filterable: false, sortable: false, menu: false },
                  { text: 'WaterLevel<br/>(' + TFMSLevelUnit + ')', datafield: 'WaterLevel', cellsalign: 'center', width: "8%", renderer: columnrendererDouble, cellsrenderer: datarenderer, filterable: false, sortable: false, menu: false },
                  { text: 'Avg Temp<br/>(°C)', datafield: 'TempAvg', cellsalign: 'center', width: "7%", renderer: columnrendererDouble, cellsrenderer: datarenderer, filterable: false, sortable: false, menu: false },
                  { text: 'Amb Density<br/>(Kg/cm³)', datafield: 'DensityAmb', cellsalign: 'center', width: "8%", renderer: columnrendererDouble, cellsrenderer: datarenderer, filterable: false, sortable: false, menu: false },
                  { text: 'Std Density<br/>(Kg/cm³)', datafield: 'DensityStd', cellsalign: 'center', width: "8%", renderer: columnrendererDouble, cellsrenderer: datarenderer, filterable: false, sortable: false, menu: false },
                  { text: 'Level Rate<br/>(m/hr)', datafield: 'LevelRate', cellsalign: 'center', width: "7%", renderer: columnrendererDouble, cellsrenderer: datarenderer, filterable: false, sortable: false, menu: false },
                  { text: 'Flow Rate<br/>(m³/hr)', datafield: 'FlowRate', cellsalign: 'center', width: "8%", renderer: columnrendererDouble, cellsrenderer: datarenderer, filterable: false, sortable: false, menu: false },
                  { text: 'Gross Volume<br/>(KL)', datafield: 'TOV', cellsalign: 'center', width: "8%", renderer: columnrendererDouble, cellsrenderer: datarenderer, filterable: false, sortable: false, menu: false },
                  { text: 'Level Diff<br/>Alarm', datafield: 'Pri_Sec_Diff_Alert', cellsalign: 'center', width: "5%", renderer: columnrendererDouble, cellsrenderer: cellsrenderer, filterable: false, sortable: false, menu: false },
                  { text: 'Safety<br/>Level', datafield: 'SecLevel', cellsalign: 'center', width: "5%", renderer: columnrendererDouble, cellsrenderer: datarenderer, hidden: hiddenProp, filterable: false, sortable: false, menu: false },
                  { text: 'Level<br/>Diff', datafield: 'Pri_Sec_Lvl_Diff', cellsalign: 'center', width: "5%", renderer: columnrendererDouble, cellsrenderer: datarenderer, hidden: hiddenProp, filterable: false, sortable: false, menu: false },
                ]
            });
...
//    var result;
//    var clsName = item.ControlName.toUpperCase();
