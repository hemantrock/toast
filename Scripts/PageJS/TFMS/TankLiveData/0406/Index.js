        ...
        success: function (result) {
            ...
            $("#jqxgridTkLiveData").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Tank Code', datafield: 'TankCode', cellsalign: 'left', filtertype: "checkedlist", width: "9%", pinned: true },
                  { text: 'Tank Name', datafield: 'TankName', cellsalign: 'left', filtertype: "checkedlist", width: "9%", pinned: true },
                  { text: 'Product', datafield: 'ProductName', cellsalign: 'left', filtertype: "checkedlist", width: "18%", pinned: true },
                  //{ text: 'TankMode', datafield: 'TankMode', cellsalign: 'left', filtertype: "checkedlist", width: "5%" },
                  { text: 'Tank Mode', datafield: 'TankMode', displayfield: 'TankModeName', cellsalign: 'left', width: "24%" },
                  { text: 'Level ('+TFMSLevelUnit+')', datafield: 'PriLevel', cellsalign: 'center', width: "10%"},
                  { text: 'Avg Temp (°C)', datafield: 'TempAvg', cellsalign: 'center', width: "10%"},
                  { text: 'Volume (KL)', datafield: 'TOV', cellsalign: 'center', width: "10%"},
                  { text: 'Ullage (KL)', datafield: 'UllageVol', cellsalign: 'center', width: "10%"},
                ]
            });
