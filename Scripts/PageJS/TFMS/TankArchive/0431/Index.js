        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Tank Name', datafield: 'TankName', filtertype: 'checkedlist', width: '112px'},
                    { text: 'SAP Tank No', datafield: 'SAPTankNo', filtertype: 'checkedlist', width: '112px' },
                    { text: 'Product Name', datafield: 'ProductName', filtertype: 'checkedlist', width: '140px'},
                    { text: 'Tank Mode', datafield: 'ModeName', filtertype: 'checkedlist', width: '178px' },
                    //{ text: 'Dip Type', datafield: 'DipType', filtertype: 'checkedlist', width: '112px'},
                    { text: 'Servo Level (' + TFMSLevelUnit + ')', datafield: 'ProductLevel', width: '130px' },
                    { text: 'Radar Level (' + TFMSLevelUnit + ')', datafield: 'SecondaryLevel', width: '130px' },
                    ...
                    { text: 'Press (kg/cm²)', datafield: 'Pressure', width: '110px' },
                    //{ text: 'Gross Qty (KL)', datafield: 'GrossQty', width: '9%' },
                    { text: 'TOV (KL)', datafield: 'TOV', width: '112px' },
                    { text: 'Mass (Ton)', datafield: 'ProductMass', width: '106px' },
