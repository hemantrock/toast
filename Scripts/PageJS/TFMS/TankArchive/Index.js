        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                rendertoolbar: function (statusbar) {
                    ...
                    ready: function () {
                    if (nPageSize != undefined) { PageSize = nPageSize; }
                    else{ PageSize = adapter.records.length; if (PageSize > iGblNoRows-3) { PageSize = iGblNoRows; }}
                ...
                columns: [
                    ...
                    { text: 'Date Time', datafield: 'DataTimeStamp', filtertype: 'date', cellsformat: 'dd-MMM-yyyy HH:mm', width: '182px' },
                    { text: 'TankName', datafield: 'TankName', filtertype: 'checkedlist', width: '112px'},
                    { text: 'SAPTankNo', datafield: 'SAPTankNo', filtertype: 'checkedlist', width: '112px' },
                    { text: 'Product Name', datafield: 'ProductName', filtertype: 'checkedlist', width: '140px'},
                    { text: 'Tank Mode', datafield: 'ModeName', filtertype: 'checkedlist', width: '196px' },
                    //{ text: 'Dip Type', datafield: 'DipType', filtertype: 'checkedlist', width: '112px'},
                    { text: 'Level (' + TFMSLevelUnit + ')', datafield: 'ProductLevel', width: '112px' },
                    //{ text: 'Sec.Level (' + TFMSLevelUnit + ')', datafield: 'SecondaryLevel', width: '112px' },
                    //{ text: 'StdDens(kg/m³)', datafield: 'StdDensity', width: '0px', hidden: true },
                    { text: 'Dens(kg/m³)', datafield: 'AmbDensity', width: '126px' },
                    { text: 'Temp (°C)', datafield: 'TempProduct', width: '112px' },
                    //{ text: 'Water Level (' + TFMSLevelUnit + ')', datafield: 'FreeWaterLevel', width: '8%' },
                    //{ text: 'Press (kg/cm²)', datafield: 'Pressure', width: '6%' },
                    //{ text: 'Gross Qty (KL)', datafield: 'GrossQty', width: '9%' },
                    { text: 'TOV (KL)', datafield: 'TOV', width: '112px' },
                    //{ text: 'Mass (Kg)', datafield: 'ProductMass', width: '8%' },
                    //{ text: 'SAPResponse', datafield: 'SAPResponse', width: '14%' },
                    { text: 'PostStatus', datafield: 'PostStatus', filtertype: 'checkedlist', width: '98px' },
                    { text: 'PostedBy', datafield: 'PostedBy', width: '98px' },
                    { text: 'SAP Response', datafield: 'SAPResponse', width: '400px' },
...
function SetPageSize() {
    debugger;
    var tempHght = screenHeight - 156 - 80;
    nPageSize = Math.floor(tempHght / 33);
    if (nPageSize <= 1) {
        nPageSize = 1;
    }
}