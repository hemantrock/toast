        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'AmbDens(kg/m³)', datafield: 'AmbDensity', width: '126px' },
                    { text: 'Temp (°C)', datafield: 'TempProduct', width: '82px' },
                    { text: 'StdDens(kg/m³)', datafield: 'StdDensity', width: '126px'},
                    //{ text: 'Dens(kg/m³)', datafield: 'AmbDensity', width: '126px', hidden: true },
                    ...
                    { text: 'PostStatus', datafield: 'PostStatus', filtertype: 'checkedlist', width: '90px' },
                    { text: 'PostedBy', datafield: 'PostedBy', width: '90px' },
