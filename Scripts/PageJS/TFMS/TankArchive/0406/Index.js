        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Tank Name', datafield: 'TankName', filtertype: 'checkedlist', width: '10%'},
                    //{ text: 'SAP Tank No', datafield: 'SAPTankNo', filtertype: 'checkedlist', width: '6%'},
                    { text: 'Product Name', datafield: 'ProductName', filtertype: 'checkedlist', width: '18%'},
                    { text: 'Tank Mode', datafield: 'ModeName', filtertype: 'checkedlist', width: '24%' },
                    { text: 'Level (' + TFMSLevelUnit + ')', datafield: 'ProductLevel', width: '8%' },
                    { text: 'Temp (°C)', datafield: 'TempProduct', width: '8%' },
                    { text: 'Gross Qty (KL)', datafield: 'TOV', width: '8%' },
                    //{ text: 'SAPResponse', datafield: 'SAPResponse', width: '14%' },
                    { text: 'PostStatus', datafield: 'PostStatus', filtertype: 'checkedlist', width: '7%' },
