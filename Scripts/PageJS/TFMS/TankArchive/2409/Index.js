        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Date Time', datafield: 'DataTimeStamp', filtertype: 'date', cellsformat: 'dd-MMM-yyyy HH:mm', width: '162px' },
                    { text: 'TankName', datafield: 'TankName', filtertype: 'checkedlist', width: '85px'},
                    { text: 'SAPTankNo', datafield: 'SAPTankNo', filtertype: 'checkedlist', width: '85px' },
                    { text: 'Product Name', datafield: 'ProductName', filtertype: 'checkedlist', width: '115px'},
                    { text: 'Tank Mode', datafield: 'ModeName', filtertype: 'checkedlist', width: '145px' },
                    //{ text: 'Dip Type', datafield: 'DipType', filtertype: 'checkedlist', width: '112px'},
                    { text: 'Pri.Level (' + TFMSLevelUnit + ')', datafield: 'ProductLevel', width: '105px' },
                    ...
                    { text: 'Dens(kg/m³)', datafield: 'AmbDensity', width: '100px' },
                    { text: 'Temp (°C)', datafield: 'TempProduct', width: '82px' },
                    { text: 'Water(' + TFMSLevelUnit + ')', datafield: 'FreeWaterLevel', width: '81px' },
                    //{ text: 'Press (kg/cm²)', datafield: 'Pressure', width: '6%' },
                    //{ text: 'Gross Qty (KL)', datafield: 'GrossQty', width: '9%' },
                    { text: 'TOV (KL)', datafield: 'TOV', width: '100px' },
                    //{ text: 'Mass (Kg)', datafield: 'ProductMass', width: '8%' },
                    //{ text: 'SAPResponse', datafield: 'SAPResponse', width: '14%' },
                    { text: 'PostSatus', datafield: 'PostStatus', filtertype: 'checkedlist', width: '80px' },
                    { text: 'PostedBy', datafield: 'PostedBy', width: '88px' },
                    { text: 'SAP Response', datafield: 'SAPResponse', width: '460px' },
