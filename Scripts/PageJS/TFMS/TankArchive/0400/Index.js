        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Level (' + TFMSLevelUnit + ')', datafield: 'ProductLevel', width: '6%' },
                    { text: 'Std. Density (kg/m³)', datafield: 'StdDensity', width: '6%', hidden: true },
                    { text: 'AmbDensity(kg/m³)', datafield: 'AmbDensity', width: '6%' },
