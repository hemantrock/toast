...
$(document).ready(function () {
    ...
    clearTimeout(gblTimeout);
    gblTimeout = setTimeout(function () { RefreshTTData(); }, 5000);
            ...
            $("#jqxTTQgrid").jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        { text: 'Post Method', datafield: 'PostedMethod', width: "5%", filtertype: 'checkedlist' },
                        { text: 'Posted Status', datafield: 'PostedStatusDesc', width: "28%", filtertype: 'checkedlist' },
                        { text: 'Posted Time', datafield: 'PostedTime', width: "10%", filtertype: 'date', cellsformat: 'dd-MMM-yy HH:mm:ss' },
                        { text: 'Sensor', datafield: 'SensorDesc', width: "4%", filtertype: 'checkedlist' },
                        ...
                        { text: ERPName + ' Post', datafield: 'Ack', width: "4%", cellsrenderer: cellsrendererPost, cellsalign: 'center' },
