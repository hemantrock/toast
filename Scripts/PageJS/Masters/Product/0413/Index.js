        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Code', datafield: 'ProductCode', width: "6%", cellsalign: 'center' },
                  { text: 'Product Name', datafield: 'ProductName', width: "12%", filtertype: 'checkedlist' },
                  { text: 'Product Color', datafield: 'ProductColor', width: "9%", filterable: false, cellsrenderer: cellsrenderer },
                  ...
                  //{ text: 'Max Density', datafield: 'MaxDensity', width: "5%", cellsalign: 'center', filtertype: 'checkedlist' },
                    { text: 'Amb Dens (Kg/m³)', datafield: 'Density', width: "8%", cellsalign: 'center' },
                    { text: 'Std Dens (Kg/m³)', datafield: 'StdDensity', width: "8%", cellsalign: 'center' },
                  ...
                  { text: 'UoM', datafield: 'UOM', width: "5%", cellsalign: 'center', filtertype: 'checkedlist' },
