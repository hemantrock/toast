        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Code', datafield: 'ProductCode', width: "7%", cellsalign: 'center' },
                  { text: 'Product Name', datafield: 'ProductName', width: "9%", filtertype: 'checkedlist' },
                  { text: 'Product Color', datafield: 'ProductColor', width: "12%", filterable: false, cellsrenderer: cellsrenderer },
                  { text: 'Short Name', datafield: 'ProdNameShort', width: "7%" },
                  { text: 'Product Description', datafield: 'ProductDescription', width: "18%" },
                  { text: 'Components', datafield: 'Components', width: "16%", cellsalign: 'left' },
                  { text: 'Additive', datafield: 'Additive', width: "8%", cellsalign: 'left' },
                  { text: 'Min Density', datafield: 'MinDensity', width: "6%", cellsalign: 'center', filtertype: 'checkedlist' },
                  { text: 'Max Density', datafield: 'MaxDensity', width: "6%", cellsalign: 'center', filtertype: 'checkedlist' },
