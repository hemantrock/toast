var selectedRowId, selectedRowRef, bayId, BCNo, HideCleanStart = true; // GridWidth = "1250px", 
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  { text: 'BayID', datafield: 'BayID', width: "8%", filtertype: 'checkedlist', cellsalign: 'center' },
                  { text: 'ArmNo', datafield: 'ArmNo', filtertype: 'checkedlist', width: "8%", cellsalign: 'center' },
                  { text: 'LP No', datafield: 'LoadingPointNo', width: "8%", cellsalign: 'center' },
                  { text: 'BC No', datafield: 'BCNo', width: "8%", cellsalign: 'center' },
                  { text: 'Products', datafield: 'ProductNames', width: "36%" },
                  { text: 'LP Enabled', datafield: 'LPStatus', threestatecheckbox: true, columntype: 'checkbox', filtertype: 'checkedlist', width: "7%" },
                  { text: 'Flushing', datafield: 'ToDoFlushing', threestatecheckbox: true, columntype: 'checkbox', filtertype: 'checkedlist', width: "7%" },
                  { text: 'AcuID', datafield: 'AcuID', width: "8%", cellsalign: 'center' },
                  { text: 'LoadingType', datafield: 'LoadingType', filtertype: 'checkedlist', width: "10%", cellsalign: 'center' },
