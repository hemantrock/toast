            ...
            $("#jqxgrid").jqxGrid(
                {
                    ...
                    columns: [
                        { text: 'BayID', datafield: 'BayID', width: "4%", filtertype: 'checkedlist', cellsalign: 'center' },
                        { text: 'ArmNo', datafield: 'ArmNo', filtertype: 'checkedlist', width: "4%", cellsalign: 'center' },
                        { text: 'LPNo', datafield: 'LoadingPointNo', width: "4%", cellsalign: 'center' },
                        { text: 'BCNo', datafield: 'BCNo', width: "4%", cellsalign: 'center' },
                        { text: 'Products', datafield: 'ProductNames', width: "30%" },
                        { text: 'LP Enabled', datafield: 'LPStatus', threestatecheckbox: true, columntype: 'checkbox', filtertype: 'checkedlist', width: "6%" },
                        //{ text: 'AcuID', datafield: 'AcuID', width: "5%", cellsalign: 'center' },
                        { text: 'Load Dir.', datafield: 'LoadingType', filtertype: 'checkedlist', width: "6%", cellsalign: 'center' },
                        { text: 'Purpose', datafield: 'LoadPurposeDesc', filtertype: 'checkedlist', width: "6%", cellsalign: 'center' },
                        { text: 'MaintMode', width: "5%", cellsalign: 'center', cellsrenderer: cellsrendererNonCommMode },
                        { text: 'LAPS Bypass', datafield: 'IsLAPSBypassed', threestatecheckbox: true, columntype: 'checkbox', filtertype: 'checkedlist', width: "6%" },
                        { text: 'CleanStart', width: "5%", cellsalign: 'center', cellsrenderer: cellsrendererClearStart, hidden: HideCleanStart },
