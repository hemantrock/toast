        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'TankName', datafield: 'TankName', width: "8%", filtertype: "custom", createfilterpanel: function (datafield, filterPanel) { buildFilterPanel(filterPanel, datafield); } },
                  { text: 'ERPTankNo', datafield: 'SAPTankNo', width: "8%", cellsalign: 'center', filtertype: "custom", createfilterpanel: function (datafield, filterPanel) { buildFilterPanel(filterPanel, datafield); } },
                  { text: 'PlantCode', datafield: 'PlantCode', width: "7%", cellsalign: 'center', filtertype: 'checkedlist' },
                  { text: 'TankType', datafield: 'TankType', width: "7%", filtertype: 'checkedlist' },
                  ...
                  { text: 'Ref.Height', datafield: 'DipReferenceHeight', width: "10%", cellsalign: 'center' },
                  { text: 'NominalDia', datafield: 'NominalDia', width: "10%", cellsalign: 'center' },
                  { text: 'MaxVolume', datafield: 'MaxVolume', width: "12%", cellsalign: 'center' },
                  { text: 'Tank Mode', datafield: 'TankMode', width: "12%", filtertype: 'checkedlist' },
                ]
            });
