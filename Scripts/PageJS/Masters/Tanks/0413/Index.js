            ...
            $("#jqxgrid").jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        { text: 'Product Name', datafield: 'ProductName', width: "18%", filtertype: 'checkedlist' },
                        { text: 'Product Grp', datafield: 'ProductGrp', width: "9%", filtertype: 'checkedlist' },
                        { text: 'Primary Gauge', datafield: 'PrimaryGaugeType', width: "12%", filtertype: 'checkedlist' },
                        ...
                        { text: 'MaxVolume', datafield: 'MaxVolume', width: "9%", cellsalign: 'center' },
                        { text: 'Density', datafield: 'Density', width: "8%", cellsalign: 'center' },
