        ...
        success: function (result) {
            ...
            var source =
            {
                datafields: [
                    ...
                    { name: 'PrintedTareWeight', type: 'number' },
                    { name: 'TareWeightAvg', type: 'number' },
                    { name: 'TareWeightPrev', type: 'number' },
                    { name: 'LadenWeight', type: 'number' },
            ...
            $.ajax({
                ...
                success: function (TrkDetailsResult) {
                    ...
                    var initrowdetails = function (index, parentElement, gridElement, record) {
                        ...
                        if (grid != null) {
                            grid.jqxGrid({
                                source: nestedGridAdapter, width: 750, height: 70,
                                columns: [
                    ...
                    $("#jqxgrid").jqxGrid(
                        {
                            ...
                            rendertoolbar: function (statusbar) {
                                ...
                                var tableHeading = $("<div style='float: left; margin-left: 5px;' class='heading-lbl'><span style='margin-left: 4px; position: relative; top: -3px;'>Trucks Master - Bulk</span></div>");
                            ...
                            rowdetailstemplate: {
                                rowdetails: "<div id='grid' style='margin: 10px;'></div>", rowdetailsheight: 90, rowdetailshidden: true
                            },
                            ...
                            columns: [
                                ...
                                { text: 'Transporter', datafield: 'TptrDescCode', width: '20%' }, //filtertype: "custom", createfilterpanel: function (datafield, filterPanel) { buildFilterPanel(filterPanel, datafield); } },
                                ...
                                { text: 'RFID EPC Code', datafield: 'RFID_Code', width: '15%' },
                                //{ text: 'Loading Type', datafield: 'LoadTypeDesc', filtertype: 'checkedlist', width: '8%', cellsalign: 'center' },
                                { text: 'Tare Wt Avg', datafield: 'TareWeightAvg', width: '6%', cellsalign: 'right' },
                                { text: 'Tare Wt Prev', datafield: 'TareWeightPrev', width: '6%', cellsalign: 'right' },
                                { text: 'Max Weight', datafield: 'MaxWeight', width: '6%', cellsalign: 'right' },
                                { text: 'CCOE Weight', datafield: 'CCOEWeight', width: '6%', cellsalign: 'right' },
                                { text: 'TT Driver', datafield: 'TTDriver', width: '24%' },
                                //{ text: 'Calibration ExpDate', datafield: 'CalibrationExpDate', filtertype: 'date', width: '8%', cellsformat: 'dd-MMM-yyyy' },
                                //{ text: 'Explosive Lisc ExpDate', datafield: 'ExplosiveLiscExpDate', filtertype: 'date', width: '8%', cellsformat: 'dd-MMM-yyyy' },
                                //{ text: 'License ExpDate', datafield: 'LicenseExpiryDate', filtertype: 'date', width: '8%', cellsformat: 'dd-MMM-yyyy' },
                            ]
                        });
...
function SetLPGTrkDefaultRows() {
    //var temp = screenHeight - 440;  //Used for DataTables
    var temp = screenHeight - 165;    //Used for JQX Tables
