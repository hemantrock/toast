                    ...
                    $("#jqxgrid").jqxGrid(
                        {
                            ...
                            columns: [
                                ...
                                { text: 'Truck Number', datafield: 'TruckNumber', width: '10%', filtertype: "custom", createfilterpanel: function (datafield, filterPanel) { buildFilterPanel(filterPanel, datafield); } },
                                ...
                                { text: 'Comps', datafield: 'TotalNoOfComp', filtertype: 'checkedlist', width: '5%', cellsalign: 'center' },
                                { text: 'Card Number', datafield: 'CardNumber', width: '7%', cellsalign: 'right', filtertype: "custom", createfilterpanel: function (datafield, filterPanel) { buildFilterPanel(filterPanel, datafield); } },
                                { text: 'Loading Type', datafield: 'LoadTypeDesc', filtertype: 'checkedlist', width: '8%', cellsalign: 'center' },
                                { text: 'Max Volume', datafield: 'MaxVolume', width: '10%', cellsalign: 'right' },
...
function SetTrkDefaultRows() {
    iNoRows = GetNoOfRows(35, 'jqx');
    console.log('NoOfRows:' + iNoRows);
}