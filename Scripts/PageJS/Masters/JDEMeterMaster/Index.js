...
function OpenAddJDEMeterMaster() {
    $.ajax({
        type: "GET",
...
function deleteJDEMeterMaster(Id) {
    $.ajax({
        type: "GET",
        url: "/JDEMeterMaster/Delete?Id=" + Id,
        UpdateTargetId: "dvContent",
        cache: false,
        success: function (result) {
            if (result == "pass") {
