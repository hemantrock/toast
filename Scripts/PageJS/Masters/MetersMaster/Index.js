    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  { text: 'Meter ID', datafield: 'MeterID', width: "8%", cellsalign: 'center' },
                  { text: 'Bay No', datafield: 'BayNo', width: "7%", cellsalign: 'center', filtertype: 'checkedlist' },
                  { text: 'Arm No', datafield: 'ArmNo', width: "7%", cellsalign: 'center',filtertype: 'checkedlist' },
                  { text: 'LP No', datafield: 'LPNo', width: "0%", cellsalign: 'center', hidden:true ,filtertype: 'checkedlist' },
                  { text: 'LP Meter#', datafield: 'MeterCompNo', width: "8%", cellsalign: 'center', filtertype: 'checkedlist' },
                  { text: 'Base Product', datafield: 'ActiveProduct', width: "15%", filtertype: 'checkedlist' },
                  { text: 'Meter Desc', datafield: 'MeterDesc', width: "35%", filtertype: "custom", createfilterpanel: function (datafield, filterPanel) { buildFilterPanel(filterPanel, datafield); }, },
                  //{ text: 'UnAuthFlow Tot', datafield: 'UnAuthFlowTot', width: "7%", cellsalign: 'center' },
                  { text: 'AckUnAuthFlow', datafield: 'UnAuthFlowAck', width: "12%", cellsrenderer: cellsrendererUnAuth, cellsalign: 'center' },
                  ...
                  { text: 'Slave ID', datafield: 'SlaveID', width: "8%", cellsalign: 'center', filtertype: 'checkedlist' },
