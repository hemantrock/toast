     ...
     $('#FormBU').bootstrapValidator({
        ...
        fields: {
            TagID: {
                validators: {
                    notEmpty: {
                        message: 'The Tag ID is required and cannot be empty'
                    },
                    stringLength: {
                        min: 3,
                        max: 30,
                        message: 'The Tag ID should be between 3 to 30 characters long'
                    }
                }
            },
            EPC_Code: {
                validators: {
                    notEmpty: {
                        message: 'The EPC Code is required and cannot be empty'
                    },
                    stringLength: {
                        min: 3,
                        max: 30,
                        message: 'The EPC Code should be between 3 to 30 characters long'
                    }
                }
            },
            ...
            RFIDStatus: {
                validators: {
                    notEmpty: {
                        message: 'The RFID Status is required and cannot be empty'
                    },
                    greaterThan: {
                        value: 1,
                        message: 'Select RFID Type'
