                    ...
                    var initrowdetails = function (index, parentElement, gridElement, record) {
                        ...
                        if (grid != null) {
                            grid.jqxGrid({
                                ...
                                source: nestedGridAdapter, width: '1000px', height: 70,
                                columns: [
                                    ...
                                    { text: 'Dispatch Loc', datafield: 'CustomerDesc', width: '150px' },
                                    { text: 'Preset', datafield: 'PresetQty', width: '70px' },
                                    { text: 'Unloaded', datafield: 'Filled', width: '70px' },
                                    ...
                                    { text: 'UnLoad Start', datafield: 'LoadingStartTime', width: '110px', filtertype: 'date', cellsformat: 'dd-MMM HH:mm' },
                                    { text: 'UnLoad End', datafield: 'LoadingEndTime', width: '110px', filtertype: 'date', cellsformat: 'dd-MMM HH:mm' },
                                    { text: 'Status', datafield: 'Status', filtertype: 'checkedlist', width: '130px' },
                                    //{ text: 'Source', datafield: 'Destination', width: '150px' },
                                ]
                            });
                        }
                    }
                    ...
                    $("#jqxULSgrid").jqxGrid(
                        {
                            ...
                            rendertoolbar: function (statusbar) {
                                ...
                                var tableHeading = $("<div style='float: left; margin-left: 5px;' class='heading-lbl'><span style='margin-left: 4px; position: relative; top: -3px;'>BULK TRUCKS - UNLOADING</span></div>");
                            ...
                            columns: [
                                ...
                                { text: 'Unloaded', datafield: 'DeliveredQty', width: '4.5%' },
                                ...
                                { text: 'Seq No', datafield: 'FANSlipNo', width: '7.5%' },
                            ]
                        });
            ...
            $("#jqxgridULSummary").jqxGrid(
                {
                    ...
                    rendertoolbar: function (statusbar) {
                        // appends buttons to the status bar.
                        var container = $("<div class='jqx-header-wrapper' style='overflow: hidden; position: relative; margin: 5px;'></div>");
                        var tableHeading = $("<div style='float: left; margin-left: 5px;' class='heading-lbl'><span style='margin-left: 4px; position: relative; top: -3px;'>Bulk Trucks - Unloading Count</span></div>");
