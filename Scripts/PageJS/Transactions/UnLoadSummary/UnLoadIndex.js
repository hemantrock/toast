Purpose = 2;
function RefreshUnLoadSummary() {
    $.when(GetUnLoadSummary(), TruckDetailUnLoadSummary()).then(function () {
        if ($('#jqxULSgrid').hasClass("jqx-widget") == false) { return; }
        $('#jqxULSgrid').jqxGrid('updatebounddata', 'cells');
        ...
        $("#TruckAssigmentOptions").html(CreateHtmlforAccess($('#jqxULSgrid').jqxGrid('getrowdata', $('#jqxULSgrid').jqxGrid('selectedrowindex'))));
    }, function () { console.log('ajax error in RefreshUnLoadSummary'); });
    ...
    var Request = $.ajax({
        ...
        success: function (result) {
            ...
            if ($('#jqxgridULSummary').hasClass("jqx-widget") == false) { return; }
            $('#jqxgridULSummary').jqxGrid('updatebounddata', 'cells');
        },
...
function TruckDetailUnLoadSummary() {
