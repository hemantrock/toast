...
function RefreshLoadSummary() {
    $.when(GetLoadSummary(), TruckDetailSummary()).then(function () {
        if ($('#jqxERVTrksGrid').hasClass("jqx-widget") == false) { return; }
        $('#jqxERVTrksGrid').jqxGrid('updatebounddata', 'cells');
        ...
        $("#TruckAssigmentOptions").html(CreateHtmlforAccess($('#jqxERVTrksGrid').jqxGrid('getrowdata', $('#jqxERVTrksGrid').jqxGrid('selectedrowindex'))));
    }, function () { console.log('ajax error in RefreshLoadSummary'); });

    var Request = $.ajax({
        type: "GET",
        url: "/PackLoads/ERVSummaryData?iPurpose=" + Purpose,
        cache: false,
        beforeSend: function () { },
        complete: function () { },
        success: function (result) {
            ...
            if ($('#jqxERVSummary').hasClass("jqx-widget") == false) { return; }
            $('#jqxERVSummary').jqxGrid('updatebounddata', 'cells');
        },
...
function GetLoadSummary() {
    ...
    return $.ajax({
        type: "GET",
        url: "/PackLoads/ERVTrucksData?Purpose=" + Purpose,
        cache: false,
        beforeSend: function () { },
        complete: function () { },
        success: function (result) {
...
function TruckDetailSummary() {
    ...
    return $.ajax({
        type: "GET",
        url: "/PackLoads/ERVDetailsData?Purpose=" + Purpose,
        cache: false,
        beforeSend: function () { },
        complete: function () { },
