...
function RefreshLoadSummary() {
    $.when(GetLoadSummary(), TruckDetailSummary()).then(function () {
        if ($('#jqxPLTrksGrid').hasClass("jqx-widget") == false) { return; }
        $('#jqxPLTrksGrid').jqxGrid('updatebounddata', 'cells');
        ...
        $("#TruckAssigmentOptions").html(CreateHtmlforAccess($('#jqxPLTrksGrid').jqxGrid('getrowdata', $('#jqxPLTrksGrid').jqxGrid('selectedrowindex'))));
    }, function () { console.log('ajax error in RefreshLoadSummary'); });

    var Request = $.ajax({
        type: "GET",
        url: "/PackLoads/PackLoadSummaryData?iPurpose=" + Purpose,
        cache: false,
        beforeSend: function () { },
        complete: function () { },
        success: function (result) {
            ...
            if ($('#jqxPLSummary').hasClass("jqx-widget") == false) { return; }
            $('#jqxPLSummary').jqxGrid('updatebounddata', 'cells');
        },
...
function GetLoadSummary() {
    ...
    return $.ajax({
        type: "GET",
        url: "/PackLoads/PackLoadTrucksData?Purpose=" + Purpose,
        cache: false,
        beforeSend: function () { },
        complete: function () { },
        success: function (result) {
...
function TruckDetailSummary() {
    ...
    return $.ajax({
        type: "GET",
        url: "/PackLoads/PackLoadDetailsData?Purpose=" + Purpose,
        cache: false,
        beforeSend: function () { },
        complete: function () { },
