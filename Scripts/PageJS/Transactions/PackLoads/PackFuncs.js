    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                ...
                ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { TruckSickDo(LoadID); }, activityName, activityDetail);
            }
        }
    });
}
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                ...
                ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { BaySickDo(LoadID); }, activityName, activityDetail);
            }
        }
    });
}
...
function TruckRegularize(LoadID, activityDetail) {
    ...
    var activityName = "Truck Regularize";
    $.ajax({
        type: "GET",
        url: "/Home/ValidateRequiredTrnPwd?activityName=" + activityName,
        cache: false,
        success: function (result) {
            if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                ...
                ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { TruckRegularizeView(LoadID); }, activityName, activityDetail);
            }
        }
    });
}
