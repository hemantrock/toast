        ...
        success: function (result) {
            ...
            var source =
            {
                ...
                datafields: [
                    ...
                    { name: 'TankObsDens', type: 'number' },
                    { name: 'TankTemp', type: 'number' },
                    { name: 'TankStdDens', type: 'number' },
            ...
            $("#jqxgrid").jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        { text: 'Baseline Date Time', datafield: 'BaselineDT', filtertype: 'date', width: "8%", cellsformat: 'dd-MMM-yy HH:mm' },
                        { text: 'Product Name', datafield: 'ProductName', width: "12%", filtertype: 'checkedlist' },
                        { text: 'Std.Density<br/>(kg/m³)', datafield: 'Density', cellsalign: 'center', width: "5%", renderer: columnrendererDouble },
                        { text: 'Temp<br/>ºC', datafield: 'Temp', cellsalign: 'center', width: "4%", renderer: columnrendererDouble },
                        { text: 'ObsTempSrc', datafield: 'ObsTempSrc', hidden: true },
                        { text: 'StdDensSrc', datafield: 'StdDensSrc', hidden: true },
                        { text: 'Mode', datafield: 'Mode', cellsalign: 'center', width: "4%", filtertype: 'checkedlist' },
                        { text: 'User Name', datafield: 'UserName', width: "6%", filtertype: "custom", createfilterpanel: function (datafield, filterPanel) { buildFilterPanel(filterPanel, datafield); }, cellsalign: 'center' },
                        { text: 'Sampling<br/>Start', datafield: 'SamplingStart', width: "8%", filtertype: 'date', cellsformat: 'dd-MMM-yy HH:mm', renderer: columnrendererDouble, cellsalign: 'center' },
                        { text: 'Sampling<br/>End', datafield: 'SamplingEnd', width: "8%", filtertype: 'date', cellsformat: 'dd-MMM-yy HH:mm', renderer: columnrendererDouble, cellsalign: 'center' },
                        { text: 'MeterIDs', datafield: 'MeterIDs', cellsalign: 'center', width: "6%" },
                        { text: 'TempIDs', datafield: 'TempIDs', cellsalign: 'center', width: "6%" },
                        { text: 'Tank Name', datafield: 'TankName', cellsalign: 'center', width: "5%" },
                        //{ text: 'TankObsDens', datafield: 'TankObsDens', cellsalign: 'center', hidden: true },
                        //{ text: 'Tank Std<br/>Dens (kg/m³)', datafield: 'TankStdDens', cellsalign: 'center', width: "6%", renderer: columnrendererDouble },
                        //{ text: 'Tank Temp<br/>ºC', datafield: 'TankTemp', cellsalign: 'center', width: "5%", renderer: columnrendererDouble },
                        { text: 'Remarks', datafield: 'Remarks', cellsalign: 'center', width: "28%" }, //width: "17%"
                    ]
                });
...
function EditRecord(Id, selectedRowType) {
    ...
    else if (selectedRowType.toUpperCase() == "AUTO") {
        alertDismissable("danger", "Cannot Edit 'Auto' Mode Density & Temperature.");
    }
    else {
        $.ajax({
            type: "GET",
