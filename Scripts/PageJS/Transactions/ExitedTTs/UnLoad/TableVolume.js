                ...
                success: function (DetailsResultOutput) {
                    ...
                    $("#jqxExitedLSgrid").jqxGrid(
                    {
                        ...
                        rendertoolbar: function (statusbar) {
                            ...
                            var tableHeading = $("<div style='float: left; margin-left: 5px;' class='heading-lbl'><span style='margin-left: 4px; position: relative; top: -3px;'>EXITED UNLOADING TT SUMMARY</span></div>");
