                ...
                success: function (DetailsResultOutput) {
                    ...
                    $("#jqxExitedLSgrid").jqxGrid(
                    {
                        ...
                        columns: [
                             ...
                             { text: 'Truck No', datafield: 'TruckNumber', width: '10%' },
                             ...
                             { text: 'Card#', datafield: 'CardNumber', width: '5%' },
                             { text: 'ReqQty', datafield: 'RequiredQty', width: '5%' },
                             { text: 'Filled', datafield: 'DeliveredQty', width: '5%' },
