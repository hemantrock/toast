...
$(document).ready(function () {
    ...
    $.ajax({
        type: "GET",
        url: "/LoadSummary/GetExitedLoadSummaryData",
        cache: false,
        beforeSend: function () { },
        complete: function () { },
        success: function (result) {
            ...
            $.ajax({
                type: "GET",
                url: "/LoadSummary/ExitedLoadDetailsData",
                cache: false,
                beforeSend: function () { },
                complete: function () { },
                success: function (DetailsResultOutput) {
                    ...
                    $("#jqxExitedLSgrid").jqxGrid(
                    {
                        ...
                        rendertoolbar: function (statusbar) {
                            ...
                            var tableHeading = $("<div style='float: left; margin-left: 5px;' class='heading-lbl'><span style='margin-left: 4px; position: relative; top: -3px;'>EXITED TTs SUMMARY</span></div>");
                        ...
                        columns: [
                             ...
                             { text: 'Post Load', datafield: 'PostLoadDateTime', width: '5%', filtertype: 'date', cellsformat: 'dd-MMM HH:mm' },
                             { text: 'Exit Gate', datafield: 'ExitGateTime', width: '6%', filtertype: 'date', cellsformat: 'dd-MMM HH:mm' },
                             { text: 'FAN No', datafield: 'FANSlipNo', width: '4%'},
                        ]
                    });
