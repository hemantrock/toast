...
function initAudio(ImagePath, CamNbr, MediaRecording, ptz, streamProfileNr, streamProfileName)
{
  ...
  Player.AudioConfigURL = confHost + "/axis-cgi/view/param.cgi?camera=" + CamNbr +  "&usergroup=anonymous&action=list&group=Audio,AudioSource,Properties.Audio" + ((!isNaN(streamProfileNr) && streamProfileNr != false )? ",StreamProfile.S" + streamProfileNr : "");
