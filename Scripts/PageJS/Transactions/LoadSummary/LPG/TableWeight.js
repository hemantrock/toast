...
var LastExpandedRow, iNoRows = 22;
//var truckStatus;
$(document).ready(function () {
    ...
    $.ajax({
        type: "GET",
        url: "/LoadSummary/GetLoadSummaryData",
        cache: false,
        beforeSend: function () { },
        complete: function () { },
        success: function (result) {
            ...
            $.ajax({
                type: "GET",
                url: "/LoadSummary/TruckDetailsData",
                cache: false,
                beforeSend: function () { },
                complete: function () { },
                    ...
                    var initrowdetails = function (index, parentElement, gridElement, record) {
                        ...
                        if (grid != null) {
                            grid.jqxGrid({
                                ...
                                source: nestedGridAdapter, width: '1210px', height: 70,
                                columns: [
                                    { text: 'LoadID', datafield: 'LoadID', width: '100px' },
                                    { text: 'LP#', datafield: 'LoadingPointNo', width: '55px', cellsalign: 'center' },
                                    { text: 'Comp#', datafield: 'CompNo', width: '55px', cellsalign: 'center' },
                                    { text: 'Product', datafield: 'ProductName', filtertype: 'checkedlist', width: '150px' },
                                    //{ text: 'Customer', datafield: 'CustomerDesc', width: '104px' },
                                    { text: 'Preset', datafield: 'PresetQty', width: '70px' },
                                    { text: 'Filled', datafield: 'Filled', width: '70px' },
                    ...
                    $("#jqxLSgrid").jqxGrid(
                        {
                            ...
                            rendertoolbar: function (statusbar) {
                                ...
                                var tableHeading = $("<div style='float: left; margin-left: 5px;' class='heading-lbl'><span style='margin-left: 4px; position: relative; top: -3px;'>BULK TRUCKS - LOADING</span></div>");
                            ...
                            rowdetailstemplate: {
                                rowdetails: "<div id='grid' style='margin: 10px;'></div>", rowdetailsheight: 100, rowdetailshidden: true
                            },
                            ...
                            columns: [
                                ...
                                { text: 'Truck Status', datafield: 'TruckStatusDesc', width: '10%', filtertype: 'checkedlist' },
                                { text: 'Product(s)', datafield: 'ProdNameShort', width: '5%' },
                                ...
                                { text: 'Filled', datafield: 'EffQty', width: '4%' },
                                ...
                                { text: 'Card Issue', datafield: 'CardReAuthorizeTime', width: '5%', filtertype: 'date', cellsformat: 'HH:mm:ss' },
                                { text: 'FAN Print', datafield: 'FANPrintTime', width: '5%', filtertype: 'date', cellsformat: 'HH:mm:ss' },
                                { text: 'TT Time', datafield: 'TotalSeconds', width: '5%', filterable: false, cellsformat: 'HH:mm:ss' },
                                { text: 'Gate Entry', datafield: 'EntryGateTime', width: '5%', filtertype: 'date', cellsformat: 'HH:mm:ss' },
                                { text: 'Bay Report', datafield: 'BayReportingTime', width: '5%', filtertype: 'date', cellsformat: 'HH:mm:ss' },
                                { text: 'Post Load', datafield: 'PostLoadDateTime', width: '5%', filtertype: 'date', cellsformat: 'HH:mm:ss' },
                                { text: 'Exit Gate', datafield: 'ExitGateTime', width: '5%', filtertype: 'date', cellsformat: 'HH:mm:ss' },
            ...
            $("#jqxgridSummary").jqxGrid(
                {
                    ...
                    rendertoolbar: function (statusbar) {
                        // appends buttons to the status bar.
                        var container = $("<div class='jqx-header-wrapper' style='overflow: hidden; position: relative; margin: 5px;'></div>");
                        var tableHeading = $("<div style='float: left; margin-left: 5px;' class='heading-lbl'><span style='margin-left: 4px; position: relative; top: -3px;'>Bulks Trucks - Loading Count</span></div>");
