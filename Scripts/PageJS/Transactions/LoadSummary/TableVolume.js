                        ...
                        if (grid != null) {
                            grid.jqxGrid({
                                ...
                                columns: [
                                    ...
                                    { text: 'Bay', datafield: 'BayNo', width: '2.5%', filtertype: 'checkedlist', cellsalign: 'center' },
                                    { text: 'LP#', datafield: 'LoadingPointNo', width: '2.5%', filtertype: 'checkedlist', cellsalign: 'center' },
                                    { text: 'Comp#', datafield: 'CompNo', width: '3%', filtertype: 'checkedlist', cellsalign: 'center' },
                                    { text: 'Code', datafield: 'ProductCode', filtertype: 'checkedlist', width: '4%' },
                    ...
                    $("#jqxLSgrid").jqxGrid(
                        {
                            ...
                            columns: [
                                ...
                                { text: 'Truck Status', datafield: 'TruckStatusDesc', width: '9%', filtertype: 'checkedlist' },
                                ...
                                { text: 'Customer', datafield: 'CustDesc', width: '14%' },
            ...
            $("#jqxgridSummary").jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        { text: 'Sick/ Cancelled', datafield: 'SickTTs', width: "11%", cellsalign: 'center' },
