        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                    ...
                    ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { CardToBeReallocatedDo(Id); }, activityName, activityDetail, Id);
                }
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                    ...
                    ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { CardReauthorizeDo(Id); }, activityName, activityDetail, Id);
                }
            }
        });
    });
...
function CardAssignView(LoadID) {
    ...
    $.ajax({
        ...
        cache: false,
        success: function (CardAssignResult) {
            $('#myModalBody').html('');
            $('#myModalBody').html(CardAssignResult);
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                    ...
                    ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { return GetPrintFAN_AutoDo(Id); }, activityName, activityDetail, Id);
                }
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                    ...
                    ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { return GetPrintUAN(Id); }, activityName, activityDetail, Id);
                }
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                    ...
                    ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { GetPrintBOLDo(Id); }, activityName, activityDetail, Id);
                }
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                    ...
                    ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { ManualCompleteTTView(LoadID); }, activityName, activityDetail, LoadID);
                }
            }
        });
    });
...
function ManualCompleteTTView(LoadID) {
    ...
    alertDismissable('info', 'Initiating Manually Complete for LoadID:' + LoadID + '....');
    ...
    $.ajax({
        ...
        cache: false,
        success: function (ManCompleteResult) {
            $('#myModalBody').html('');
            $('#myModalBody').html(ManCompleteResult);
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                    ...
                    ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { DeallocateBayDo(Id); }, activityName, activityDetail, Id);
                }
            }
        });
    });
...
function ManualPost(LoadID) {
    ...
    $('#myConfirmMsg').html("<p>Are you sure to Manually Post Invoice Data to " + ERPName + "?</p>");
    $('#confirmModal').modal('show');
    $('#confirmModal').draggable({ handle: ".modal-header" });
    $("#btnConfirmOK").unbind('click');
    $("#btnConfirmOK").on("click", function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                    ...
                    ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { ManualPostDo(Id); }, activityName, activityDetail, Id);
                }
            }
        });
    });
...
function ManualPostDo(LoadID) {
    alertDismissable("info", "Initiating Manual Posting for LoadID:" + LoadID);
    $.ajax({
        type: "GET",
        url: "/LoadSummary/ManualInvoicePost?LoadID=" + LoadID,
        cache: false,
        success: function (ManualPostResult) {
            $('#EmptyModal').html('');
            $('#EmptyModal').html(ManualPostResult);
...
function TruckTopUp(LoadID) {
    var Id = LoadID;
    if (Id == null || Id == "" || Id == 'undefined' || Id == 0) {
        return false;
    }
    $('#myConfirmMsg').html("<p>Are you sure Qty is short and you want to TopUp Truck?</p>");
    $('#confirmModal').modal('show');
    $('#confirmModal').draggable({ handle: ".modal-header" });
    $("#btnConfirmOK").unbind('click');
    $("#btnConfirmOK").on("click", function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                    ...
                    ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { TruckTopUpView(Id); }, activityName, activityDetail, Id);
                }
            }
        });
    });
...
function TruckTopUpView(LoadID) {
    alertDismissable("info", "Initiating TopUp for LoadID:" + LoadID);
    $.ajax({
        type: "GET",
        url: "/LoadSummary/TruckTopUpView?LoadID=" + LoadID,
        cache: false,
...
function TruckCancel(LoadID, ApproverId) {
    ...
    $.ajax({
        ...
        cache: false,
        success: function (TTCancelResult) {
            $('#myModalBody').html('');
            $('#myModalBody').html(TTCancelResult);
...
function TruckAbort(LoadID, ApproverId) {
    ...
    $.ajax({
        ...
        cache: false,
        success: function (TTAbortResult) {
            $('#myModalBody').html('');
            $('#myModalBody').html(TTAbortResult);
...
function TruckSick(LoadID, activityDetail) {
    if (LoadID == null || LoadID == "" || LoadID == 'undefined' || LoadID == 0) {
        return false;
    }
    var activityName = "TT Sick";
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                ...
                ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { TruckSickDo(LoadID); }, activityName, activityDetail, LoadID);
            }
        }
    });
}

function TruckSickDo(LoadID) {
    $.ajax({
        type: "GET",
        url: "/LoadSummary/TruckSickDo?LoadID=" + LoadID,
        cache: false,
        success: function (result) {
            alertDismissable(result.strType, result.strMessage);
            if (result.blnStatus == true) {
...
function BaySick(LoadID, activityDetail) {
    if (LoadID == null || LoadID == "" || LoadID == 'undefined' || LoadID == 0) {
        return false;
    }
    var activityName = "Bay Sick";
    $.ajax({
        type: "GET",
        url: "/Home/ValidateRequiredTrnPwd?activityName=" + activityName,
        cache: false,
        success: function (result) {
            if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                ...
                ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { BaySickDo(LoadID); }, activityName, activityDetail, LoadID);
            }
        }
    });
}

function BaySickDo(LoadID) {
    $.ajax({
        type: "GET",
        url: "/LoadSummary/BaySickDo?LoadID=" + LoadID,
        cache: false,
        success: function (result) {
            alertDismissable(result.strType, result.strMessage);
            if (result.blnStatus == true) {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                    ...
                    ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { TruckCheckOutDo(Id); }, activityName, activityDetail, Id);
                }
            }
        });
    });
...
function TruckTerminate(LoadID) {
    ...
    $("#btnConfirmOK").on("click", function () {
        ...
        $.ajax({
            ...
            cache: false,
            success: function (TerminateResult) {
                $('#myModalBody').html('');
                $('#myModalBody').html(TerminateResult);
...
function TruckRegularize(LoadID, activityDetail) {
    if (LoadID == null || LoadID == "" || LoadID == 'undefined' || LoadID == 0) {
        alertDismissable("danger", "Please select Proper Load");
        return false;
    }
    var activityName = "TT Regularize";
    $.ajax({
        type: "GET",
        url: "/Home/ValidateRequiredTrnPwd?activityName=" + activityName,
        cache: false,
        success: function (result) {
            if (result.blnStatus != 'undefined' && result.blnStatus == false) {
                TruckRegularizeView(LoadID);
            }
            else {
                ShowPasswordModalForReqTrn(activityName + " : Requires Transaction Password", function () { TruckRegularizeView(LoadID); }, activityName, activityDetail, LoadID);
            }
        }
    });
}

function TruckRegularizeView(LoadID) {
    var Id = LoadID;
    if (Id == null || Id == "" || Id == 'undefined' || Id == 0) {
        alertDismissable("danger", "Error in getting LoadID to Regularize");
        return false;
    }
    alertDismissable("info", "Initiating Regularize for LoadID:" + LoadID);
    $.ajax({
        type: "GET",
        ...
        success: function (RegularizeResult) {
            $('#myModalBody').html('');
            $('#myModalBody').html(RegularizeResult);
...
function SampleQtyView(LoadID, ApproverId) {
    ...
    $.ajax({
        ...
        cache: false,
        success: function (SamplingQtyResult) {
            $('#myModalBody').html('');
            $('#myModalBody').html(SamplingQtyResult);
...
function CreateHtmlforAccess(row) {
    if (row == undefined || row.TruckStatusID == undefined) { return ""; }
    var objTruckStatus;
    ...
    if (objTruckStatus != null && row.PurposeID == 1 && row.BayReportingTime == null && objTruckStatus.TruckCancel == true && gblCustName == 'HPCL') {
        HtmlContent = '<div class="text-right">' +
            '<a id="btnSampleQty" role="button" class="btn btn-primary" href="#" onclick="ShowPasswordModalForReqTrn(\'Add Sampling Qty\', function (ApproverId) { SampleQtyView(\'' + row.LoadID + '\',ApproverId); } , \'Add Sampling Qty\', \'' + activityDetail + '\', \'' + row.LoadID + '\');">' +
    ...
    if (objTruckStatus != null && objTruckStatus.Regularize == true) {   // && row.LoadDetStatus.indexOf('2') < 0 - Removed dtd 06-10-2020.
        HtmlContent = HtmlContent + '<div class="text-right">' +
            '<a id="btnRegularize" role="button" class="btn btn-primary" href="#" onclick="TruckRegularize(\'' + row.LoadID + '\',\'' + activityDetail + '\');">' +
    ...
    if (objTruckStatus != null && objTruckStatus.TruckCancel == true) {
        HtmlContent = HtmlContent + '<div class="text-right">' +
            '<a id="btnTruckCancel" role="button" class="btn btn-primary" href="#" onclick="ShowPasswordModalForReqTrn(\'Truck Cancel\', function (ApproverId) { TruckCancel(\'' + row.LoadID + '\',ApproverId); } , \'TT Cancel\', \'' + activityDetail + '\', \'' + row.LoadID + '\');">' +
    ...
    if (objTruckStatus != null && objTruckStatus.TruckAbort == true) {
            HtmlContent = HtmlContent + '<div class="text-right">' +
                '<a id="btnTruckAbort" role="button" class="btn btn-primary" href="#" onclick="ShowPasswordModalForReqTrn(\'Truck Abort\', function (ApproverId) { TruckAbort(\'' + row.LoadID + '\',ApproverId); }, \'TT Abort\', \'' + activityDetail + '\', \'' + row.LoadID + '\');">' +
    ...
    if (objTruckStatus != null && objTruckStatus.TruckSick == true) {
        HtmlContent = HtmlContent + '<div class="text-right">' +
            '<a id="btnTruckSick" role="button" class="btn btn-primary" href="#" onclick="TruckSick(\'' + row.LoadID + '\',\'' + activityDetail + '\');">' +
    ...
    if (objTruckStatus != null && objTruckStatus.BaySick == true) {
        HtmlContent = HtmlContent + '<div class="text-right">' +
            '<a id="btnBaySick" role="button" class="btn btn-primary" href="#" onclick="BaySick(\'' + row.LoadID + '\',\'' + activityDetail + '\');">' +
    ...
    if (objTruckStatus != null && objTruckStatus.TopUp == true) {
        HtmlContent = HtmlContent + '<div class="text-right">' +
            '<a id="btnTruckTopUp" role="button" class="btn btn-primary" href="#" onclick="TruckTopUp(\'' + row.LoadID + '\');">' +
    ...
    if (objTruckStatus != null && objTruckStatus.TruckTerminate == true) {
        HtmlContent = HtmlContent + '<div class="text-right">' +
            '<a id="btnTruckTerminate" role="button" class="btn btn-primary" href="#" onclick="ShowPasswordModalForReqTrn(\'TT Terminate\', function (ApproverId) { TruckTerminate(\'' + row.LoadID + '\',ApproverId); }, \'TT Terminate\',\'' + activityDetail + '\', \'' + row.LoadID + '\');">' +
    ...
    if ((row.ManualPost == true && objTruckStatus.PostLoad == true && row.PostLoadDateTime == null && row.PostedAckDateTime == null) ||
        (objTruckStatus.PostLoad == true && gblProtocol == 'LPG' && gblCustName == 'IOCL'))
    {
        HtmlContent = HtmlContent + '<div class="text-right">' +
