            ...
            $.ajax({
                ...
                success: function (DetailsResultOutput) {
                    ...
                    var initrowdetails = function (index, parentElement, gridElement, record) {
                        ...
                        if (grid != null) {
                            grid.jqxGrid({
                                ...
                                source: nestedGridAdapter, width: '100%', height: 90,
                                columns: [
                                    ...
                                    { text: 'Product', datafield: 'ProductName', filtertype: 'checkedlist', width: '10%' },
                                    { text: 'Customer', datafield: 'CustomerDesc', width: '13%' },
                                    { text: 'Preset', datafield: 'PresetQty', width: '6%' },
                                    { text: 'Filled', datafield: 'Filled', width: '6%' },
                                    { text: 'Base Prod', datafield: 'BaseProduct', width: '6%' },,
                                    { text: 'TopUp', datafield: 'TopUpQty', width: '6%' },
                                    { text: 'Decanted', datafield: 'DecantedQty', width: '6%' },
                                    ...
                                    { text: 'Status', datafield: 'Status', filtertype: 'checkedlist', width: '7%' },
                    ...
                    $("#jqxLSgrid").jqxGrid(
                    {
                        ...
                        rowdetailstemplate: {
                            rowdetails: "<div id='grid' style='margin: 10px;'></div>", rowdetailsheight:80, rowdetailshidden: true
                        },
                        ...
                        columns: [
                             ...
                             { text: 'Product', datafield: 'ProdNameShort', width: '4%' },
                             { text: 'Bay(s)', datafield: 'BayID', width: '3%', cellsalign: 'center' },
                             { text: 'Card#', datafield: 'CardNumber', width: '4%' },
                             { text: 'ReqQty', datafield: 'RequiredQty', width: '4%' },
                             { text: 'Filled', datafield: 'DeliveredQty', width: '4%' },
                             { text: 'Card Issue', datafield: 'CardReAuthorizeTime', width: '7%', filtertype: 'date', cellsformat: 'dd-MMM HH:mm' },
                             { text: 'FAN Print', datafield: 'FANPrintTime', width: '7%', filtertype: 'date', cellsformat: 'dd-MMM HH:mm' },
                             { text: 'TT Time', datafield: 'TotalSeconds', width: '5%', filterable: false, cellsformat: 'HH:mm:ss' },
                             { text: 'Gate Entry', datafield: 'EntryGateTime', width: '7%', filtertype: 'date', cellsformat: 'dd-MMM HH:mm' },
                             { text: 'Bay Reporting', datafield: 'BayReportingTime', width: '7%', filtertype: 'date', cellsformat: 'dd-MMM HH:mm' },
                             { text: 'Post Load', datafield: 'PostLoadDateTime', width: '7%', filtertype: 'date', cellsformat: 'dd-MMM HH:mm' },
                             { text: 'Invoice Print', datafield: 'ReportPrintedDateTime', width: '7%', filtertype: 'date', cellsformat: 'dd-MMM HH:mm' },
                             { text: 'Shipment', datafield: 'ShipmentNo', width: '6%' },
                        ]
                    });
