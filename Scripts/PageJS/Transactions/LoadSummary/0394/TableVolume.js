                        ...
                        if (grid != null) {
                            grid.jqxGrid({
                                ...
                                columns: [
                                    ...
                                    { text: 'Preset', datafield: 'PresetQty', width: '5%' },
                                    { text: 'Filled', datafield: 'Filled', width: '5%' },
                                    { text: 'Base Prod', datafield: 'BaseProduct', width: '5%' },
                                    { text: 'Additive1', datafield: 'Additive1', width: '5%' },
                                    { text: 'Blend', datafield: 'Blending', width: '5%' },
                                    { text: 'TopUp', datafield: 'TopUpQty', width: '5%' },
                                    { text: 'Decanted', datafield: 'DecantedQty', width: '5%' },
                                    { text: 'EffQty', datafield: 'EffQty', width: '5%' },
                    ...
                    $("#jqxLSgrid").jqxGrid(
                        {
                            ...
                            columns: [
                                ...
                                { text: 'Truck Status', datafield: 'TruckStatusDesc', width: '8%', filtertype: 'checkedlist' },
                                ...
                                { text: 'FAN No', datafield: 'FANSlipNo', width: '5%' },
                            ]
                        });
