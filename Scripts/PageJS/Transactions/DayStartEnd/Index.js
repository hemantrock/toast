...
function DoOnDocReady() {
    $.when(getMetersData(), getTFMSData()).then(function () {
        ...
        success: function (result) {
            ...
            meterSource =
            {
                ...
                datafields: [
                    ...
                    { name: 'CurrTotalizer', type: 'number' },
                    { name: 'PrevSnapDateTime', type: 'date' },
                    { name: 'PrevSnapshotType', type: 'string' },
                    { name: 'PrevTotalizer', type: 'number' },
                    { name: 'TotalizerDiff', type: 'number' },
                ],
                localdata: data,
                id: "UniqueID"
            };

            var adapter = new $.jqx.dataAdapter(meterSource);

            $("#jqxgridMeters").jqxGrid(
                {
                    width: "100%",
                    source: adapter,
                    columnsresize: true,
                    ...
                    rendertoolbar: function (statusbar) {
                        ...
                        var tableHeading = $("<div style='float: left; margin-left: 5px;' class='heading-lbl'><span style='margin-left: 4px; position: relative; top: -3px;'>Meter Data</span></div>");
                    ...
                    ready: function () {
                        ...
                        $("#jqxgridMeters").jqxGrid({ pagesize: PageSize });
                        $("#jqxgridMeters").jqxGrid({ pagesizeoptions: [PageSize, PageSize * 2, PageSize * 3] });
                    },
                    autoshowfiltericon: true,
                    columns: [
                        { text: 'CurrSnapshotID', datafield: 'CurrSnapshotID', width: "0%", hidden: true },
                        { text: 'MeterID', datafield: 'CurrMeterID', width: "5%", cellsalign: 'center' },
                        { text: 'Bay No', datafield: 'BayNo', width: "5%", filtertype: 'checkedlist', cellsalign: 'center' },
                        { text: 'Arm No', datafield: 'ArmNo', width: "5%", filtertype: 'checkedlist', cellsalign: 'center' },
                        { text: 'Meter No', datafield: 'MeterNo', width: "10%", cellsalign: 'left' },
                        { text: 'Product', datafield: 'ProdName', width: "10%", cellsalign: 'left', filtertype: 'checkedlist' },
                        { text: 'End DateTime', datafield: 'CurrSnapDateTime', width: "12%", cellsformat: 'dd-MMM-yy HH:mm', filtertype: 'date', },
                        { text: 'End Totalizer', datafield: 'CurrTotalizer', width: "15%" },
                        { text: 'Start DateTime', datafield: 'PrevSnapDateTime', width: "12%", cellsformat: 'dd-MMM-yy HH:mm', filtertype: 'date', },
                        { text: 'Start Totalizer', datafield: 'PrevTotalizer', width: "15%" },
                        { text: 'Totz. Difference', datafield: 'TotalizerDiff', width: "11%", aggregates: ['sum'] }
                    ]
                });
            ...
            $("#jqxgridTFMS").jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        { text: 'End DateTime', datafield: 'CurrSnapDateTime', width: "10%", cellsalign: 'center', cellsformat: 'dd-MMM-yy HH:mm', filtertype: 'date', },
                        { text: 'End Level', datafield: 'CurrProductLevel', width: "6%", cellsalign: 'center' },
                        { text: 'End Temp', datafield: 'CurrTempProduct', width: "6%", cellsalign: 'center' },
                        //{ text: 'End Gross', datafield: 'CurrGrossQty', width: "7%", cellsalign: 'center' },
                        { text: 'End Density15', datafield: 'CurrDensityStd', width: "8%", cellsalign: 'center' },
                        { text: 'End NetQty15', datafield: 'CurrNetQtyAt15', width: "8%", cellsalign: 'center' },
                        //{ text: 'End TOV', datafield: 'CurrTOV', width: "7%", cellsalign: 'center' },
                        //{ text: 'End GrossQty15', datafield: 'CurrGrossQtyAt15', width: "7%", cellsalign: 'center' },
                        //{ text: 'End NetQty', datafield: 'CurrNetQty', width: "7%", cellsalign: 'center' },
                        { text: 'Start DateTime', datafield: 'PrevSnapDateTime', width: "10%", cellsalign: 'center', cellsformat: 'dd-MMM-yy HH:mm', filtertype: 'date', },
                        { text: 'Start Level', datafield: 'PrevProductLevel', width: "6%", cellsalign: 'center', filtertype: 'checkedlist' },
                        { text: 'Start Temp', datafield: 'PrevTempProduct', width: "6%", cellsalign: 'center' },
                        //{ text: 'Start Gross', datafield: 'PrevGrossQty', width: "7%", cellsalign: 'center' },
                        { text: 'Start Density15', datafield: 'PrevDensityStd', width: "8%", cellsalign: 'center' },
                        { text: 'Start NetQty15', datafield: 'PrevNetQtyAt15', width: "8%", cellsalign: 'center' },
                        //{ text: 'Start TOV', datafield: 'PrevTOV', width: "7%", cellsalign: 'center' },
                        //{ text: 'Start GrossQty15', datafield: 'PrevGrossQtyAt15', width: "7%", cellsalign: 'center' },
                        //{ text: 'Start NetQty', datafield: 'PrevNetQty', width: "7%", cellsalign: 'center' },
...
function DayStartEndFilter() {
    ...
    if (dayStartDate == '' || dtd.length != 3) {
        ...
        if (StartDate.setHours(0, 0, 0, 0) == todaysDate.setHours(0, 0, 0, 0)) {
            ...
            $.when(RefreshMeterData(dayStartDate), RefreshTFMSData(dayStartDate)).then(function () {
                var MtrDiff = $("#jqxgridMeters").jqxGrid('getcolumnaggregateddata', 'TotalizerDiff', ['sum']);
                var LvlDiff = $("#jqxgridTFMS").jqxGrid('getcolumnaggregateddata', 'ProductLevelDiff', ['sum']);
...
function RefreshMeterData(dayStartDate) {
    return $.ajax({
        type: "GET",
        url: "/DayStartEnd/GetMeterData?dayStartDate=" + dayStartDate,
        cache: false,
        beforeSend: function () { },
        complete: function () { },
        success: function (result) {
            ...
            meterSource.localdata = newMeterSource.localdata;
            //$('#jqxgridMeters').jqxGrid('updatebounddata', 'cells');
            $('#jqxgridMeters').jqxGrid('updatebounddata');
        },
        error: function (xhr, status, error) {
            console.log(xhr.responseText);
        }
