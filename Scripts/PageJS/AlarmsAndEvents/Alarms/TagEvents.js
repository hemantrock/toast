...
$(document).ready(function () {
    ...
    $.ajax({
        type: "GET",
        url: "/AlarmsAndEvents/TagEventsData",
        cache: false,
        beforeSend: function () { },
        complete: function () { },
        success: function (result) {
            ...
            $("#jqxTagEventGrid").jqxGrid(
            {
                ...
                rendertoolbar: function (statusbar) {
                    ...
                    var tableHeading = $("<div style='float: left; margin-left: 5px;' class='heading-lbl'><span style='margin-left: 4px; position: relative; top: -3px;'>Process Alarms and Events</span></div>");
